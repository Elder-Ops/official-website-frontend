...
const Services = () => {
  return (
    <section className="container relative py-22 md:py-25">
      <img
        src={dotParticle}
      ...
      <Animated
        variant="slideUp"
        className="max-w-160.5 mx-auto text-center mb-16"
      >
      ...
      <div className="grid grid-cols-1 gap-16 md:gap-20 sm:grid-cols-2 lg:grid-cols-3 overflow-hidden">
        <Animated
          variant="slideRight"
          delay={0.1}
        ...
        >
          ...
          <h2 className="border-2 font-urbanist border-[#8BA396] size-14 rounded-full font-medium text-2xl text-primary flex items-center justify-center">
          ...
          <img
            src={line}
            alt=""
            className="my-6 md:my-8 w-full sm:w-auto"
            role="presentation"
          />

          <SectionTitle className="mb-2 text-2xl! md:leading-8! lg:max-w-68 lg:text-3xl! lg:leading-9.5!">
            {servicesData[0].title}
          </SectionTitle>
          <p className="text-accent-two text-sm">
        ...
        >
          ...
          <SectionTitle className="mb-2 text-2xl! md:leading-8! lg:max-w-97.5 lg:text-3xl! lg:leading-9.5!">
